...
import { Calendar,Users, Home,ChevronLeft,ChevronRight, ClipboardList,CircleDollarSign,ShoppingBag,ChartLine,Plus,ShoppingCart, NotebookPen, Truck, Minus,Store, Settings, Undo2 } from "lucide-react"
    ...
    <div id="sidebar" className={`z-30 md:w-fit border-r w-0 p-0 relative`}>
      <div data-open={sidebarOpen} className={`flex flex-col justify-between p-0 relative transition-all ease-out duration-200 data-[open=true]:ease-in-out data-[open=true]:duration-300 bg-[#fafbfc] h-full ${sidebarOpen ? "w-[60svw] sm:w-[35svw] md:w-48" : "w-0 md:w-[2.75rem] "}`}>
          ...
          <div data-carousel={carousel} className="w-[200%] flex rounded-md data-[carousel=true]:right-full h-full right-0  duration-200 transition-[right_160ms_ease-in-out] relative ">
            ...
            <div className="flex h-full px-0 w-1/2 justify-center">
              <section className="flex-col h-fit w-full p-3">
                <Button variant='ghost' className='relative -mt-2 px-1 font-bold h-6 '><Undo2/></Button>
        ...
        <SidebarFooter data-open={sidebarOpen} className=' min-h-6 transition-all duration-300 data-[open=true]:px-3 px-0'>
             <Button size='xs' data-mobile={sidebarOpen} variant={'ghost'}  className='w-full text-core_contrast data-[mobile=false]:hover:bg-transparent relative border-none data-[active=true]:border data-[mobile=false]:hover:shadow-none shadow-none outline-none hover:bg-transparent hover:text-black transition-all ease-in-out data-[mobile=true]:duration-75 flex justify-start overflow-x-hidden duration-200 px-2 py-1 h-fit data-[mobile=true]:rounded-md rounded-none'>
            ...
            <Popover className='z-0'>
              <PopoverTrigger asChild>
                <Button size='xs' data-mobile={sidebarOpen} variant={'ghost'}  className='w-full text-core_contrast data-[mobile=false]:border-none data-[mobile=false]:shadow-none hover:bg-[#f7f7f7] data-[mobile=false]:hover:bg-transparent relative border-t hover:data-[mobile=false]:shadow-none shadow-md outline-none hover:text-black transition-all ease-in-out data-[mobile=true]:duration-75 flex justify-start overflow-x-hidden duration-200 px-2 py-1 h-fit data-[mobile=true]:rounded-md rounded-none'>
          ...
          <Popover className='z-0'>
            <PopoverTrigger asChild>
              <Button size='xs' data-mobile={sidebarOpen} variant={'ghost'}  className='w-full text-core_contrast data-[mobile=false]:border-none data-[mobile=false]:shadow-none hover:bg-[#f7f7f7] data-[mobile=false]:hover:bg-transparent relative border-t hover:data-[mobile=false]:shadow-none shadow-md outline-none hover:text-black transition-all ease-in-out data-[mobile=true]:duration-75 flex justify-start overflow-x-hidden duration-200 px-2 py-1 h-fit data-[mobile=true]:rounded-md rounded-none'>
                        <Avatar data-mobile={sidebarOpen} className='items-center border border-[#cacaca] data-[mobile=false]:hover:shadow-md hover:bg-[#e7e7e7]  data-[mobile=true]:mr-4 mr-1 transition-all duration-300 h-7 w-7 inline-flex rounded-full justify-center'>
                      <Image src={profilePix} className='bg-white border border-[#e8e8e8] w-full ' alt="@storeprobuilder"/>
