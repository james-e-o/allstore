...
const InputBox = ({label,placeholder,error,flexdir,type,width,margin,change,inputDir,blurr,value,note,textarea,grow,row,icon,readonly,outline,shortInput,ghost,mt,fit,uppercase,input_uppercase,font,l_font})=>{
  return(
