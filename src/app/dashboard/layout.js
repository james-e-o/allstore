...
export default function DashboardLayout({ children }) {
    ...
    return (   
        <div className='flex h-full overflow-hidden'>
            ...
            <main className='flex-grow bg-core_grey2/80 p-2 md:p-4 h-full w-svw overflow-x-hidden'> 
                <div className="bg-white flex flex-col overflow-y-hidden rounded-lg h-full">                    
                    <header className=" rounded-md p-2 mb-1 flex w-full justify-between items-center font-Inter ">
